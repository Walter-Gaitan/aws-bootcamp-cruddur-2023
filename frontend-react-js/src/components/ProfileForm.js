...
export default function ProfileForm(props) {
  ...
  const s3uploadkey = async (event)=> {
    try {
      ...
      const backend_url = "https://rteieqt6t3.execute-api.us-east-2.amazonaws.com/avatars/key_upload"
      await getAccessToken()
      const access_token = localStorage.getItem("access_token")
      const res = await fetch(backend_url, {
        method: "POST",
        headers: {
          'Origin': "https://3000-waltergaita-awsbootcamp-ywwzngpl9pe.ws-us97.gitpod.io",
